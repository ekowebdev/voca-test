...
func (m *MockLedgerRepository) GetLedgerByWalletID(ctx context.Context, walletID uuid.UUID, txType string, limit, offset int) ([]models.LedgerEntry, error) {
...
func (m *MockLedgerRepository) CountLedgerByWalletID(ctx context.Context, walletID uuid.UUID, txType string) (int64, error) {
	args := m.Called(ctx, walletID, txType)
	return args.Get(0).(int64), args.Error(1)
}

func (m *MockLedgerRepository) GetLedgerSummary(ctx context.Context, walletID uuid.UUID, txType string) (map[string]interface{}, error) {
	args := m.Called(ctx, walletID, txType)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
